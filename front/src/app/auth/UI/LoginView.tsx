    ...
    return (
        ...
        from-orange-300 via-orange-300 to-orange-200 mt-20
         ...
         >
            ...
            <div className='hidden lg:block bg-orange-300 '>
                    ...
                    onSubmit={async (values) => {
                        ...
                        if (result && result.data) {
                            ...
                            setUserData({
                                ...
                                user: {
                                    id: userData.id,
                                    name: userData.user || userData.name || response.email.split('@')[0], 
                                    // user es el username
                    ...
                    {({ isValid, isSubmitting }) => (
                        <Form className="flex flex-col justify-between my-6 rounded-2xl p-2"
                         >
                            ...
                            <button onClick={() => signIn()} className='bg-white border rounded hover:bg-sky-500
